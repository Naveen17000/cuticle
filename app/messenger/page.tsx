...
export default async function MessengerPage() {
  ...
  // Fetch conversations using service role to avoid RLS issues when reading related rows
  ...
  return <MessengerLayout user={user} profile={profile} conversationIds={conversationIds} />
}
